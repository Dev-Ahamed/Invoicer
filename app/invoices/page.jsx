...
const page = () => {
  ...
  return (
    <div className="min-h-[700px] pt-8">
      <div className="relative overflow-x-auto shadow-md sm:rounded-lg container max-w-5xl mx-auto my-8">
        <div className="flex justify-between items-center p-8">
          <h2 className="text-3xl text-violet-700">
            Invoices ({invoices?.length})
          </h2>
          <ThemeLink
            title="Create Invoice"
            href="/invoice"
            className="text-slate-100 hover:text-slate-50 bg-red-600 px-4 py-2 rounded hover:shadow-lg hover:bg-red-700 transition"
          />
        </div>
